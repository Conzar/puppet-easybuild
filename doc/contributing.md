...
# Easybuild Puppet Module Developments
...
### Directory Layout
       ...
       easybuild/       # Main directory 
           ...
           `-- manifests/
                ...
                `-- classes/     # Hold manifest for easybuild classes/
                     `-- easybuild.pp         # defines the easybuild class
                     `-- easybuild-params.pp  # easybuild module variables 
                `-- definitions/ # Hold manifest for easybuild definitions
                     `-- easybuild-mydef.pp   # defines the easybuild::mydef definition   `-- templates/        # Module ERB template files
